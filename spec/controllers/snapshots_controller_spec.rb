...
RSpec.describe SnapshotsController, type: :controller do
  ...
  describe "GET #show" do
    it "returns a success response" do
      ...
      get :show, params: {id: snapshot.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "GET #edit" do
    it "returns a success response" do
      snapshot = Snapshot.create! valid_attributes
      get :edit, params: {id: snapshot.to_param}, session: valid_session
      expect(response).to be_successful
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Snapshot" do
        expect {
          post :create, params: {snapshot: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {snapshot: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested snapshot" do
        snapshot = Snapshot.create! valid_attributes
        put :update, params: {id: snapshot.to_param, snapshot: new_attributes}, session: valid_session
        snapshot.reload
      ...
      it "redirects to the snapshot" do
        snapshot = Snapshot.create! valid_attributes
        put :update, params: {id: snapshot.to_param, snapshot: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        snapshot = Snapshot.create! valid_attributes
        put :update, params: {id: snapshot.to_param, snapshot: invalid_attributes}, session: valid_session
        expect(response).to be_successful
      end
    end
  end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested snapshot" do
      snapshot = Snapshot.create! valid_attributes
      expect {
        delete :destroy, params: {id: snapshot.to_param}, session: valid_session
      }.to change(Snapshot, :count).by(-1)
    end
